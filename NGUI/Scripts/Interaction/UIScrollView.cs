...
public class UIScrollView : MonoBehaviour
{
    ...
    /// <summary>
    /// add by Ljdong
    /// control the draging of the ScrollView.
    /// </summary>
	...
	public void Press (bool pressed)
	{
		...
		if (enabled && NGUITools.GetActive(gameObject) && isCanDrag)
		{
	...
	public void Drag ()
	{
		if (enabled && NGUITools.GetActive(gameObject) && mShouldMove && isCanDrag)
		{
