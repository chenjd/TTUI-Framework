...
public class UIGrid : UIWidgetContainer
{
    ...
    public bool isChildrenMoveIn = false;//add by ljDong
    ...
    //add by ljDong 2015-8-20
    private void ChildrenMoveIn()
    {
        if (isChildrenMoveIn)
        {
            Component comp = gameObject.GetComponent<GridItemsTween>();
            if (comp == null)
            {
                gameObject.AddComponent<GridItemsTween>();
            }
            GetComponent<GridItemsTween>().MoveGridChildren();
            isChildrenMoveIn = false;
        }
    }
}
