...
#region Convenience accessor properties
	...
	static void CopySprite (UISprite sp)
	{
		...
		SetEnum("Sprite category", sp.type);
		SetEnum("Left category", sp.leftType);
		SetEnum("Right category", sp.rightType);
		SetEnum("Top category", sp.topType);
		SetEnum("Bottom category", sp.bottomType);
		SetEnum("Center category", sp.centerType);
	...
	static void PasteSprite (UISprite sp, bool fully)
	{
		...
		sp.type = GetEnum<UISprite.Type>("Sprite category", sp.type);
		sp.leftType = GetEnum<UISprite.AdvancedType>("Left category", UISprite.AdvancedType.Sliced);
		sp.rightType = GetEnum<UISprite.AdvancedType>("Right category", UISprite.AdvancedType.Sliced);
		sp.topType = GetEnum<UISprite.AdvancedType>("Top category", UISprite.AdvancedType.Sliced);
		sp.bottomType = GetEnum<UISprite.AdvancedType>("Bottom category", UISprite.AdvancedType.Sliced);
		sp.centerType = GetEnum<UISprite.AdvancedType>("Center category", UISprite.AdvancedType.Sliced);
